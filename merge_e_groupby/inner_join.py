...
#identificar os clientes da loja a, que tambem são clientes da loja B

clientes_iguais = pd.merge(cadastro_a, cadastro_b[['ID','NOME', 'IDADE']],on=['ID'], how="inner")

print(clientes_iguais)